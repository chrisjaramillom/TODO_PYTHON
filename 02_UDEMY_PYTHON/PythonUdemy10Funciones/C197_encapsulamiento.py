...
# Ejercicio de ejemplo para definición de clases
# Con atributos públicos, protegidos y privados
# Públicos puede acceder cualquier
# Protegido puede acceder normal pero ya es mala práctica
# Privada NO debería acceder pero si se puede, es mala práctica
